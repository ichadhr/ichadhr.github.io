...
banner_image: "/media/posts/2014-07-19-getting-started-with-yeoman-&-grunt/cover.jpg"
featured: true
comments: false
---
...
The Grunt ecosystem is huge and it's growing every day {% include emoji.html name="sob" %}. With literally hundreds of plugins to choose from, you can use Grunt to automate just about anything with a minimum of effort. If someone hasn't already built what you need, authoring and publishing your own Grunt plugin to npm is a breeze.
